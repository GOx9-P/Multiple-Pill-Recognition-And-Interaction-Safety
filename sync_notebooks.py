...
def update_all_notebooks():
    cells = [
        ...
        },
        {
            ...
            "source": [
                ...
                "!pip uninstall -y -q paddlepaddle paddlepaddle-gpu paddleocr opencv-python opencv-python-headless numpy\n",
                "\n",
    ...
    for path in ["merger-fe-be.ipynb", "run_on_kaggle.ipynb"]:
